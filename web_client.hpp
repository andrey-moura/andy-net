...
namespace uva
{
    namespace networking
    {
        ...
        public:
            ...
            void get(const std::string& route, std::map<std::string, var> params, std::map<std::string, var> headers, const var& body, std::function<void(http_message)> on_success, std::function<void(error_code&)> on_error = nullptr);
        public:
